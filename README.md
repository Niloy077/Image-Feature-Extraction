...
git clone /https://github.com/Niloy077/Image-Feature-Extraction
cd <repo-name>

Run the notebook:

jupyter notebook image-feature-comparison.ipynb
...
## Contributors  
✍️ Niloy Biswas (Aiming to finish by this week.)
